...
router.post('/', auth_middleware_1.authMiddleware, product_controller_1.default.createProduct.bind(product_controller_1.default));
router.put('/:id', auth_middleware_1.authMiddleware, product_controller_1.default.updateProduct.bind(product_controller_1.default));
